...
import H1 from "../assets/h1.bmp";
import H2 from "../assets/h2.bmp";
import H3 from "../assets/h3.bmp";

function MngmntModal({ onClose }) {
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 className="text-3xl font-bold mb-4">Hospital Manangement System</h1>
        <p className="text-lg mb-4">
          A MERN stack application for managing hospital appointments,
        ...
        <div className="w-full md:flex md:justify-center md:items-center">
          <p className="flex mt-6 mb-6">
            Repository
            <a
              href="https://github.com/Error404awit/Simple-Hospital-Management-System.git"
              target="_blank"
